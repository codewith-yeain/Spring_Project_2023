    ...
    posts.forEach(post => {
        text += `
            <div class="customer-notice-list-item">
                <a href="/communtiy/listMine" class="customer-notice-feed-item">
                    <article class="customer-notice-feed-item-content">
                        <div>
                            <p class="customer-notice-feed-item-sort">${post.sortId}</p><!--창업-->
                            <h1 class="customer-notice-feed-item-title">${post.communityTitle}</h1><!--게시글 제목-->
                            <time class="customer-notice-feed-item-date">${post.communityUpdateDate}</time><!--2023.07.06-->
                        </div>
                        <aside class="card-item-action-list">
                            <button type="button" class="card-item-action-list-action">
                                ...
                                <span class="count">${post.communityReadCount}</span><!--73-->
                            </button>
                            <button type="button" class="card-item-action-list-action">
                                ...
                                <span class="count">${post.communityReadCount}</span><!--22-->
                            </button>
                        </aside>
                    </article>
                </a>
